    ...
    def go(self):
        if (self.position < self.lenmydata):
            ...
            if self.mydata[self.position] > 100 and int(self.mydata[self.position]/100)%10 == 1:
                p1 = 1 # immediate
            elif self.mydata[self.position] > 100 and int(self.mydata[self.position]/100)%10 == 2:
                p1 = 2 # relative
            else:
                p1 = 0 # positional
            if self.mydata[self.position] > 2000:
                p2 = 2
            elif self.mydata[self.position] > 1000:
                p2 = 1
            else:
                p2 = 0
            if (4 == oc):
                if 1 == p1:
                    ...
                    dout = self.mydata[self.mydata[self.position+1] + self.relative]
                else:
                ...
                if 1 == p1:
                    self.relative = self.mydata[self.position+1]
                elif 2 == p1:
                    self.relative = self.mydata[self.mydata[self.position+1] + self.relative]
                else:
                    self.relative = self.mydata[self.mydata[self.position+1]]
