...
while (0 == flag):
	i1 += 1
	print ("iteration {}".format(i1))
	for a in seq:
		val += a
		# ~ i1 += 1
		# ~ print("for iter={} a={}, val={}".format(i1,a,val))
		for line in open(filename):
			# ~ line=line.rstrip()
			# ~ print ("comparing ;;;{};;; to ;;;{};;;".format(val,line))
			if (val == int(line)):
				print ("Found a dup: {} after {} iterations".format(val,i1))
				flag = 1
				time.sleep(5)
